...
def proses_injeksi(nama_ikon, ikon_emoji, format_pilir, files, jumlah_bagi, progress_bar, status_label):
...
def info_aplikasi():
    messagebox.showinfo("About", (
        "Icon Injector NOAH - CFC Number v2.1\n\n"
        "Features:\n"
...
show_tooltip(about_label, "Learn more about the creator of this app")
...
# Telegram Link
telegram_frame = ttk.Frame(about_frame)
