...
def info_aplikasi():
    messagebox.showinfo("About", (
        "Icon Injector NOAH - CFC Number v2.4\n\n"
        "Features:\n"
...
content_frame.pack(padx=50)  # Add padding to center the content

# Features (Left)
features_subframe = ttk.Frame(content_frame)
features_subframe.pack(side="left", padx=(0, 20), fill="y")
